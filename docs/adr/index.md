...
* [Discover Bundles Instead of Configuring Them](discover-bundles.md) - Find every OKF bundle in a repository by walking for concepts, and delete the dirs configuration that used to name them.
